...
/*                                                                            */
/*   Los ejercicios de C07 son FUNCIONES, no programas: por cada caso se      */
...
static t_case	g_cases[] = {
	{"ex00", "strdup (copia nueva, puntero distinto)",
		"ex00/ft_strdup.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
		"char *ft_strdup(char *src);\n"
		"int main(void){char *s=\"Naheulbeuk\";char *d=ft_strdup(s);\n"
		"if(!d){printf(\"NULL\");return 1;}printf(\"%s|%d\",d,d!=s);"
		"free(d);return 0;}\n",
		"Naheulbeuk|1", NULL},

	{"ex01", "range (1..5, -2..2, min>=max -> NULL)",
		"ex01/ft_range.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
		"int *ft_range(int min,int max);\n"
		"int main(void){int *r=ft_range(1,5);int i;"
		"for(i=0;i<4;i++)printf(\"%d\",r[i]);\n"
		"free(r);printf(\"|\");r=ft_range(-2,2);"
		"for(i=0;i<4;i++)printf(\"%d \",r[i]);free(r);\n"
		"printf(\"|%d\",ft_range(5,1)==NULL);return 0;}\n",
		"1234|-2 -1 0 1 |1", NULL},

	{"ex02", "ultimate_range (1..5, min>=max -> 0/NULL)",
		"ex02/ft_ultimate_range.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
	...
	{"ex03", "strjoin (3 cadenas, size 0, size 1)",
		"ex03/ft_strjoin.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
		"char *ft_strjoin(int size,char **strs,char *sep);\n"
		"int main(void){char *a[3]={\"orc\",\"goblin\",\"troll\"};\n"
		"char *r=ft_strjoin(3,a,\", \");printf(\"%s\",r);free(r);"
		"printf(\"|\");\n"
		"r=ft_strjoin(0,a,\", \");printf(\"[%s]\",r);free(r);printf(\"|\");\n"
		"char *b[1]={\"solo\"};r=ft_strjoin(1,b,\"-\");printf(\"%s\",r);"
		"free(r);return 0;}\n",
		"orc, goblin, troll|[]|solo", NULL},

	{"ex04", "convert_base (bin, neg, hex, --42, 0, base invalida)",
		"ex04/ft_convert_base.c ex04/ft_convert_base2.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
		"char *ft_convert_base(char *nbr,char *bf,char *bt);\n"
		"int main(void){char *r;\n"
		"r=ft_convert_base(\"42\",\"0123456789\",\"01\");"
		"printf(\"%s|\",r);free(r);\n"
		"r=ft_convert_base(\"  -42\",\"0123456789\",\"0123456789\");"
		"printf(\"%s|\",r);free(r);\n"
		"r=ft_convert_base(\"ff\",\"0123456789abcdef\",\"0123456789\");"
		"printf(\"%s|\",r);free(r);\n"
		"r=ft_convert_base(\"--42\",\"0123456789\",\"0123456789\");"
		"printf(\"%s|\",r);free(r);\n"
		"r=ft_convert_base(\"0\",\"0123456789\",\"0123456789\");"
		"printf(\"%s|\",r);free(r);\n"
		"printf(\"%d\",ft_convert_base(\"42\",\"0123456789\",\"0\")==NULL);"
		"return 0;}\n",
		"101010|-42|255|42|0|1", NULL},

	{"ex05", "split (separadores multiples y charset)",
		"ex05/ft_split.c", NULL,
		"#include <stdio.h>\n"
		"#include <stdlib.h>\n"
		"char **ft_split(char *str,char *charset);\n"
		"int main(void){char **r=ft_split(\"  hello   world  foo \",\"  \");"
		"int i=0;\n"
		"while(r[i]){printf(\"[%s]\",r[i]);free(r[i]);i++;}free(r);"
		"printf(\"|%d|\",i);\n"
		"r=ft_split(\"aXXbYcXY\",\"XY\");i=0;"
		"while(r[i]){printf(\"[%s]\",r[i]);free(r[i]);i++;}\n"
		"free(r);printf(\"%d\",i);return 0;}\n",
		"[hello][world][foo]|3|[a][b][c]3", NULL},
};
