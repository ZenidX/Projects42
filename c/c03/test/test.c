...
/*                                                                            */
/*   Los ejercicios de C03 son FUNCIONES, no programas: por cada caso se      */
...
static t_case	g_cases[] = {
	{"ex00", "strcmp (igual/menor/mayor/prefijo)", "ex00/ft_strcmp.c", NULL,
		"#include <stdio.h>\n"
		"int ft_strcmp(char *a, char *b);\n"
		"int main(void)\n"
		"{\n"
		"\tprintf(\"%d %d %d %d\", ft_strcmp(\"abc\", \"abc\"),"
		" ft_strcmp(\"abc\", \"abd\"),\n"
	...
	{"ex01", "strncmp (corte en n, n=0)", "ex01/ft_strncmp.c", NULL,
		"#include <stdio.h>\n"
		"int ft_strncmp(char *a, char *b, unsigned int n);\n"
		"int main(void)\n"
		"{\n"
		"\tprintf(\"%d %d %d\", ft_strncmp(\"abcX\", \"abcY\", 3),"
	...
	{"ex02", "strcat", "ex02/ft_strcat.c", NULL,
		"#include <stdio.h>\n"
	...
	{"ex03", "strncat (nb bytes)", "ex03/ft_strncat.c", NULL,
		"#include <stdio.h>\n"
	...
	{"ex04", "strstr (hallado/no hallado/vacio)", "ex04/ft_strstr.c", NULL,
		"#include <stdio.h>\n"
	...
	{"ex05", "strlcat (con truncado)", "ex05/ft_strlcat.c", NULL,
		"#include <stdio.h>\n"
