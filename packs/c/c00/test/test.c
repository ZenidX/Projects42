...
static void	run_cases(void)
{
	...
	cap_end();
	cmp_out("zyxwvutsrqponmlkjihgfedcba");
}
...
{0, "ex00", "ft_putchar.c", NULL},
{1, "ex01", "ft_print_alphabet.c", NULL},
{2, "ex02", "ft_print_reverse_alphabet.c", NULL},
{3, "ex03", "ft_print_numbers.c", NULL},
{4, "ex04", "ft_is_negative.c", NULL},
{5, "ex05", "ft_print_comb.c", NULL},
{6, "ex06", "ft_print_comb2.c", NULL},
{7, "ex07", "ft_putnbr.c", NULL},
{8, "ex08", "ft_print_combn.c", NULL},
};
